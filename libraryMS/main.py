...
def edit_sub_menu(library: Library, title: str):
    edit_guide = """
        ...
        4: Go Back"""
    print(edit_guide)
    num_input = input("Enter You Choice: ")

    if check_validation(num_input):
        ...
        if num_input == 1:
            ...
            success, exception = library.edit_book(content=new_content.lower())
            if success:
    ...
    while True:
        ...
        match inp:
            ...
            case 6:
                ...
                library.borrow_book(title.lower(), borrower)
            case 7:
                title = input("Enter title of the book you want to return: ")
                borrower = input("Enter your name: ")
                library.return_book(title.lower(), borrower, is_returning=True)
            case 8:
                print(guide)
            case 9:
                print("Thank you..\n")
